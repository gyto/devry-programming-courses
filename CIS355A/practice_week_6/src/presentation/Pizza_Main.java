...
public class Pizza_Main extends javax.swing.JFrame {
    ...
    private void retrieveOrderList()  {
     ...
     private void setOrderSummary() {
        txtOrderSummary.setText(orderList.getOrderSummary());
    }
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Order Total Summary", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(0, 0, 80))); // NOI18N
        jPanel2.setForeground(new java.awt.Color(0, 0, 80));

        txtOrderSummary.setColumns(20);
        txtOrderSummary.setRows(5);
        jScrollPane3.setViewportView(txtOrderSummary);
