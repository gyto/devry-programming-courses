...
public class Pizza_Frame extends javax.swing.JFrame {
    ...
    private void clearItems() {
        ...
        // set the last name text to an empty string
        txtLastName.setText("");
        
        // set the large size radio button to true
        grpSize.setSelected(radLarge.getModel(), true);
        
        chkExtraCheese.setSelected(false);
        
        // set the sausage and ham check boxes to unchecked
        chkSausage.setSelected(false);
        chkHam.setSelected(false);
 
        // set the output field text area to empay
    ...
    private void submitOrder() {
        ...
        // set the output field text area str.ToString() to get the output
    ...
    private void initComponents() {
        ...
        pnlPersonLayout.setHorizontalGroup(
            ...
            .addGroup(pnlPersonLayout.createSequentialGroup()
                ...
                .addGroup(pnlPersonLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(txtFirstName, javax.swing.GroupLayout.DEFAULT_SIZE, 399, Short.MAX_VALUE)
        ...
        chkSausage.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                chkSausageItemStateChanged(evt);
            }
        });
    ...
    private void mnuExitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuExitActionPerformed
        // call the terminate application method
    ...
    private void radLargeItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_radLargeItemStateChanged
        // set value of Large Pizza
        if(radLarge.isSelected())
            setSize(PizzaOrder.PizzaSize.Large);
    }//GEN-LAST:event_radLargeItemStateChanged

    private void chkSausageItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_chkSausageItemStateChanged
        // set a price for Sausage if changed
        setSausage();
    }//GEN-LAST:event_chkSausageItemStateChanged

    private void chkHamItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_chkHamItemStateChanged
        // set a price for Ham if changed
        setHam();
