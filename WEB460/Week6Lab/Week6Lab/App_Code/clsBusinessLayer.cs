...
public class clsBusinessLayer
{
    ...
    public string SendEmail(
        ...
        string acctPassword)
    {
        string mailSendMessage = "Email Status: The message was sent succesfully to: " + emailTo;
        ...
        // This needs to change based on our email Host to permit our application to send email
